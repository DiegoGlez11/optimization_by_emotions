...
class gcForest(object):
    ...
    def __init__(self, shape_1X=None, n_mgsRFtree=220, window=None, stride=3,
                 cascade_test_size=0.1, n_cascadeRF=4, n_cascadeRFtree=220, cascade_layer=np.inf,
                 min_samples_mgs=20, min_samples_cascade=10, tolerance=0.0, n_jobs=-1):
        """ gcForest Classifier.
    ...
    def _window_slicing_sequence(self, X, window, shape_1X, y=None, stride=200):

...
def feature_normalize(data):
    ...
    # print("feat norm return", data_normalized.shape)
    #feat norm return (7680,)
...
def apply_mixup(dataset_file,window_size,label): # initial empty label arrays
    ...
    print("suffle data-label",shuffled_data.shape,shuffled_label.shape)
    #suffle data-label (2400, 128, 9, 9) (2400,)

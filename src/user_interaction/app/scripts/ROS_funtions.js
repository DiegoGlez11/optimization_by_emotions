...
function reset_simulation() {
    return new Promise((resolve, reject) => {
        ...
        srv.call({}).then(() => {
            ...
            // console.error("Error al iniciar la simulación");
            reject("Error al resetear la simulación");
        });
    });
}

// ++++++++++++++++++++++
// sound control of robot
// ++++++++++++++++++++++
...
// ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
// calculate distributed individuals over the front selected
// +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

function get_distributed_inds(id_pareto) {
    return new Promise((resolve, reject) => {
